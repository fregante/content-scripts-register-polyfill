...
[![Travis build status](https://api.travis-ci.com/fregante/content-scripts-register-polyfill.svg?branch=master)](https://travis-ci.com/fregante/content-scripts-register-polyfill)
